...
class _$_Results implements _Results {
  ...
  @override
  String toString() {
    return 'Results(backdropPath: $backdropPath, originalTitle: $originalTitle, releaseDate: $releaseDate, voteAverage: $voteAverage)';
  }
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, backdropPath, originalTitle, releaseDate, voteAverage);
...
abstract class _Results implements Results {
  factory _Results(
      ...
      required final double voteAverage}) = _$_Results;
