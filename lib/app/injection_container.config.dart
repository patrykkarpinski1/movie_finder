...
import 'package:movie_finder/app/injection_container.dart' as _i15;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i13.RatingCubit>(
        () => _i13.RatingCubit(gh<_i8.AccountRepository>()));
    gh.factory<_i14.WatchlistCubit>(
        () => _i14.WatchlistCubit(gh<_i8.AccountRepository>()));
    return this;
  }
}
