...
class _MovieRemoteRetrofitDataSource implements MovieRemoteRetrofitDataSource {
  ...
  @override
  Future<DetailsSeriesModel> getDetailsSeries(int seriesId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<DetailsSeriesModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = DetailsSeriesModel.fromJson(_result.data!);
    return value;
  }
